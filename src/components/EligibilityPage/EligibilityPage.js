    ...
    return (
        <div>
            ...
            <div class="eligibilityPage">
                ...
                <br/>
                { <h2> They <span style={{color: 'green'}}> are eligible</span> for the electronic home detention program.</h2>}
                <h2>Click on ‘Eligibility Criteria’ above for more information.</h2>
                <h2></h2>
                <br/>
                <br/>
