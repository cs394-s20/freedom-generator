        ...
        <div>
            <div className="ExampleEmail">
                <div className="ExampleEmailcontentBg">
                    ...
                    <h5>Feel free to use this sample email to be sent to your warden. Don't know where to find the information needed in this email? Don't worry: you can refer to our FAQs page.</h5>
